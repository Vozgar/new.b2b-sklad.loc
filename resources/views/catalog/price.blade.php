...
<section class="d-none d-xxl-block section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_xxl.aside_prices_xxl')
            <main class="col-9">
                @include('layouts.breakpoints_xxl.prices_xxl')
            </main>
...
<section class="d-none d-xl-block d-xxl-none bg-danger section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_xl.aside_prices_xl')
            <main class="col-9">
                @include('layouts.breakpoints_xl.prices_xl')
            </main>
...
<section class="d-none d-lg-block d-xl-none bg-warning section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_lg.aside_prices_lg')
            <main class="col-9">
                @include('layouts.breakpoints_lg.prices_lg')
            </main>
...
<section class="d-none d-md-block d-lg-none bg-info section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_md.aside_prices_md')
            <main class="col-9">
                @include('layouts.breakpoints_md.prices_md')
            </main>
...
<section class="d-none d-sm-block d-md-none bg-dark section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_sm.aside_prices_sm')
            <main class="col-9">
                @include('layouts.breakpoints_sm.prices_sm')
            </main>
...
<section class="d-block d-sm-none section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_xs.aside_prices_xs')
            <main class="col-9">
                @include('layouts.breakpoints_xs.prices_xs')
            </main>
