...
<section class="d-none d-xl-block d-xxl-none bg-danger section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_xl.aside_draft_edit_xl')
            <main class="col-9">
                @include('layouts.breakpoints_xl.draft_edit_xl')
            </main>
...
<section class="d-none d-lg-block d-xl-none bg-warning section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_lg.aside_draft_edit_lg')
            <main class="col-9">
                @include('layouts.breakpoints_lg.draft_edit_lg')
            </main>
...
<section class="d-none d-md-block d-lg-none bg-info section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_md.aside_draft_edit_md')
            <main class="col-9">
                @include('layouts.breakpoints_md.draft_edit_md')
            </main>
...
<section class="d-none d-sm-block d-md-none bg-dark section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_sm.aside_draft_edit_sm')
            <main class="col-9">
                @include('layouts.breakpoints_sm.draft_edit_sm')
            </main>
...
<section class="d-block d-sm-none section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            @include('layouts.breakpoints_xs.aside_draft_edit_xs')
            <main class="col-9">
                @include('layouts.breakpoints_xs.draft_edit_xs')
            </main>
