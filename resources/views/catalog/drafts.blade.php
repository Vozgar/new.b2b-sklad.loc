...
<section class="d-none d-xxl-block section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-9">
                @include('layouts.breakpoints_xxl.drafts_xxl') 
            </main>    
...
<section class="d-none d-xl-block d-xxl-none bg-danger section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-9">
                @include('layouts.breakpoints_xl.drafts_xl') 
            </main>    
...
<section class="d-none d-lg-block d-xl-none bg-warning section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-9">
                @include('layouts.breakpoints_lg.drafts_lg') 
            </main>    
...
<section class="d-none d-md-block d-lg-none bg-info section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-9">
                @include('layouts.breakpoints_md.drafts_md') 
            </main>    
...
<section class="d-none d-sm-block d-md-none bg-dark section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-9">
                @include('layouts.breakpoints_sm.drafts_sm') 
            </main>    
...
<section class="d-block d-sm-none section-content pt-0">
    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-9">
                @include('layouts.breakpoints_xs.drafts_xs') 
            </main>    
