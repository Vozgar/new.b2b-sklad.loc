...
<!--header_user_manager_xl-->
<div class="modal fade" id="header_user_manager_xl" tabindex="-1" aria-labelledby="header_user_manager_xlLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="header_user_manager_xlLabel">{{__('Your manager')}}</h4>
...
<!--header_user_support_xl-->
<div class="modal fade" id="header_user_support_xl" tabindex="-1" aria-labelledby="header_user_support_xxlLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="header_user_support_xlLabel">{{__('Support')}}</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
             <div class="modal-body">				
          <span style="font-size: 1.2em; color: Dodgerblue;">
...
<!--finish_cart_xl-->
<div class="modal fade" id="finish_cart_xl" tabindex="-1" aria-labelledby="finish_cart_xxlLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="finish_cart_xlLabel">Ваш заказ</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      Самовывоз
