    <nav class="navbar navbar-expand bg-grey header-user-xl">
        <?php
                        $user = auth()->user();
                    ?>
        <div class="container">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a href="#" class="nav-link blue b text-uppercase" data-bs-toggle="modal" data-bs-target="#header_user_manager_xl">
            ...
            <ul class="navbar-nav">
                ...
                {{-- <a class="nav-link dropdown-toggle blue b text-uppercase" href="#" id="navbarDogovorXL" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="bi bi-clipboard-check"></i> {{$user->current_contract->contractName}}
                </a> --}}
                {{-- <ul class="dropdown-menu" aria-labelledby="navbarDogovorXLLink">
