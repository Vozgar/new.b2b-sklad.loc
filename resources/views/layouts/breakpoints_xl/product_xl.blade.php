...
<div class="card">
  ...
  <span class="border-bottom"></span>
	<div class="row ">
      ...
      <span class="badge badges-xl bg-blue white text-lg m-2"> Новинка</span>
      ...
      <article class="content-body">
        ...
        <div class="mb-2">
          ...
          <var class="b dark h4">{{$product->retailPriceUah}} UAH</var>
        </div>
        <div class="mb-3">
          <var class="price h5"> {{__('l.personal_price_uah')}}: </var>
          <var class="b dark h5"> {{$product->personalPriceUah}} UAH </var>
        </div>
        <div class="mb-3">
          <var class="price h5"> {{__('l.personal_price_currency')}}: </var>
          <var class="b dark h5"> {{$product->personalPrice}} {{$product->personalPriceCurrency}} </var>
        </div>
          <hr class="mt-2 mb-2">
        <dl class="row">
          <dt class="col-4 price">Виница: </dt>
          <dd class="col-8 b dark">1шт.</dd>

          <dt class="col-4 price">{{__('l.store')}}:</dt>
          <dd class="col-8 b dark">>10</dd>

          <dt class="col-4 price">{{__('l.pack')}} 1: </dt>
          <dd class="col-8 b dark">{{$product->pack_qty}} шт. </dd>

          <dt class="col-4 price">{{__('l.pack')}} 2: </dt>
          <dd class="col-8 b dark">{{$product->pack_qty2}} шт. </dd>
        </dl>
        <hr>
        <div class="row">
