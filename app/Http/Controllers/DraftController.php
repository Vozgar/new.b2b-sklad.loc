...
class DraftController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('layouts.breakpoints_xxl.draft_edit_table_xxl', compact('products', 'categories', 'drafts'));
        }
        return view('catalog.drafts', compact('products', 'categories', 'drafts'));
    }
    ...
    public function DraftEdit(Request $request, $id = null)
    {
        ...
        if ($request->ajax()) {
            return view('layouts.breakpoints_xxl.draft_edit_table_xxl', compact('products', 'categories', 'draft'));
        }
        return view('catalog.draft_edit', compact('products', 'categories', 'draft'));
    }
